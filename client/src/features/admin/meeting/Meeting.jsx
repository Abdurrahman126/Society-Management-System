...
export const action = async ({ request }) => {
  ...
  if(intent==="post"){
    const response = await fetch('https://alimurtazaathar.pythonanywhere.com/api/add_meeting', {
      method: 'POST',
      body: formData,
    });
    ...
    const response = await fetch(`https://alimurtazaathar.pythonanywhere.com/api/delete_meeting/${id}`, {
      method: 'delete',
    });
...
export async function loader()
{
    ...
    try {
        const response = await fetch('https://alimurtazaathar.pythonanywhere.com/api/get_meetings'); 
        if (!response.ok) {
